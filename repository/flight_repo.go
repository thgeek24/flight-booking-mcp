		...
		flights: []models.Flight{
			{
				...
				DepartureTime:  must(time.Parse(time.RFC3339, "2025-04-01T10:10:00Z")),
				ArrivalTime:    must(time.Parse(time.RFC3339, "2025-04-01T13:15:00Z")),
				Price:          299.99,
				AvailableSeats: 5,
			},
			{
				...
				DepartureTime:  must(time.Parse(time.RFC3339, "2025-04-02T09:15:00Z")),
				ArrivalTime:    must(time.Parse(time.RFC3339, "2025-04-02T17:00:00Z")),
				Price:          399.99,
				AvailableSeats: 10,
			},
			{
				...
				Destination:    "Chicago",
				DepartureTime:  must(time.Parse(time.RFC3339, "2025-04-02T08:00:00Z")),
				ArrivalTime:    must(time.Parse(time.RFC3339, "2025-04-02T14:10:00Z")),
				Price:          349.99,
				AvailableSeats: 8},
		},
	}
